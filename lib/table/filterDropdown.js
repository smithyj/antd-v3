...
var FilterMenu = /*#__PURE__*/function (_React$Component) {
  ...
  function FilterMenu(props) {
    ...
    _this.setNeverShown = function (column) {
      ...
      var filterBelongToScrollBody = !!(0, _domClosest["default"])(rootNode, ".antd-v3-table-scroll");

      if (filterBelongToScrollBody) {
        // When fixed column have filters, there will be two dropdown menus
        // Filter dropdown menu inside scroll body should never be shown
        // To fix https://github.com/antd-v3-design/antd-v3-design/issues/5010 and
        // https://github.com/antd-v3-design/antd-v3-design/issues/7909
    ...
    _this.handleConfirm = function () {
      ...
      // https://github.com/antd-v3-design/antd-v3-design/issues/12284
    ...
    _this.onVisibleChange = function (visible) {
      ...
      var column = _this.props.column; // https://github.com/antd-v3-design/antd-v3-design/issues/17833
  ...
  _createClass(FilterMenu, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
       ...
       * Fixes https://github.com/antd-v3-design/antd-v3-design/issues/10289 and
       * https://github.com/antd-v3-design/antd-v3-design/issues/10209
       */
